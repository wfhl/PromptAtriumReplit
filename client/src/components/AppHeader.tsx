        ...
        <div className="flex items-center space-x-4 md:space-x-8 flex-1">
          ...
          >
            <Link href="/" className="flex items-center space-x-2 md:space-x-3 hover:opacity-80 transition-opacity">
              ...
              <h1 className="text-xl font-bold bg-gradient-to-b from-orange-400 to-purple-200 to-orange-400 bg-clip-text text-transparent whitespace-nowrap">PromptAtrium</h1>
            </Link>
          </motion.div>
